...
<div class="wide form">
	...
	'method'=>'get',
                    ...
                    <?php echo $form->textFieldControlGroup($model,'id_urgencia_medula',array('span'=>5)); ?>
                    ...
                    <?php echo $form->textFieldControlGroup($model,'tipo_transplante',array('span'=>5,'maxlength'=>10)); ?>
