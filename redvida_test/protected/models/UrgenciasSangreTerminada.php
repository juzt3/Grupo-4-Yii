...
class UrgenciasSangreTerminada extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('id_urgencia_sangre_terminada, cod_cm, id_enfermedad_urgencia, rut, nombre_paciente, apellido_pat, apellido_mat, afiliacion,grado_urgencia, tipo_sangre, cantidad_sangre, fecha_ini, fecha_fin, motivo', 'safe', 'on'=>'search'),
		);
	}
